...
Public Class XtraReport1
    ...
    Public Sub CreateEAN13BarCode1(ByVal BarCodeText As String)
        ' Create a bar code control.
        'Dim barCode As New XRBarCode1()

        ' Set the bar code's type to EAN 13.
        XrBarCode1.Symbology = New EAN13Generator()

        ' Adjust the bar code's main properties.
        XrBarCode1.Text = BarCodeText
        XrBarCode1.Width = 275
        XrBarCode1.Height = 200
    ...
    Public Function CreateBarCode(ByVal Type As BarCodeTypes) As XRBarCode
        ...
        Select Case Type
            ...
            Case BarCodeTypes.Code128
                ...
                barCode = CreateCode128BarCode(frmBarcodeProd.dgResult(0, 4).Value)
            Case BarCodeTypes.EAN8
                barCode = CreateEAN8BarCode("01234567")
            Case BarCodeTypes.EAN13
                barCode = CreateEAN13BarCode(frmBarcodeProd.dgResult(0, 4).Value.ToString)
